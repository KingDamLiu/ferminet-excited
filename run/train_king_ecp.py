...
from ferminet_ecp import loss as qmc_loss_functions
...
# Set up logging
train_schema = ['step', 'energy', 'ewmean', 'ewvar', 'variance', 'pmove','V', 'T', 'V_loc', 'V_nloc', 'delta_time']
...
with writer_manager as writer:
  ...
  for t in range(t_init, cfg.optim.iterations):
    ...
    if t % cfg.log.stats_frequency == 0:
      logging.info(
          'Step %05d: %f E_h, exp. variance=%f E_h^2, pmove=%f, delta_time=%f, T=%f, V=%f, V_loc=%f, V_nloc=%f', t,
          loss, weighted_stats.variance, pmove, delta_time, unused_aux_data.T[0], unused_aux_data.V[0], unused_aux_data.V_loc[0], unused_aux_data.V_nloc[0])
      writer.write(
          t,
          step=t,
          ...
          variance=np.asarray(unused_aux_data.variance[0]),
