...
from ferminet.main_utils import *
import numpy as np
import optax

from ferminet.wavefunction import create_network
from ferminet.loss import init_clipping_state
...
ckpt_restore_filenames = ['ferminet_2023_09_20_11:12:24/qmcjax_ckpt_004999.npz', 
    'ferminet_2023_09_21_06:27:03/qmcjax_ckpt_005000.npz', 
    'ferminet_2023_09_21_07:11:14/qmcjax_ckpt_005000.npz',
    'ferminet_2023_09_21_08:42:07/qmcjax_ckpt_005000.npz',
    'ferminet_2023_09_21_09:48:17/qmcjax_ckpt_005000.npz']
...
for i in range(len(ckpt_restore_filenames)+1):
  ...
  #   _, data, param, opt_state_ckpt, mcmc_width, clipping_state = checkpoint.restore(
  #       ckpt_restore_filename, host_batch_size)
  #   pos = kfac_jax.utils.broadcast_all_local_devices(data.positions)
  #   spins = kfac_jax.utils.broadcast_all_local_devices(data.spins)
  #   atoms = kfac_jax.utils.broadcast_all_local_devices(data.atoms)
  #   charges = kfac_jax.utils.broadcast_all_local_devices(data.charges)
  #   data = networks.FermiNetData(
  #       positions=pos, spins=spins, atoms=atoms, charges=charges
  #   )
  #   param = kfac_jax.utils.broadcast_all_local_devices(param)
  #   mcmc_width = kfac_jax.utils.broadcast_all_local_devices(mcmc_width)
  #   clipping_state = kfac_jax.utils.broadcast_all_local_devices(clipping_state)
  if ckpt_restore_filename:
  ...
  for t in range(t_init, cfg.optim.iterations):
    ...
    for unused_aux_data in unused_aux_datas:
      ...
      writer.write(
          ...
          S = np.asarray(unused_aux_data.S[0]),
