...
from ferminet_excited.integral import special
from ferminet_excited.integral.quadrature import Quadrature
...
def numerical_integral_exact(psi, r_atom, walkers, ls, quadrature: Quadrature):
    ...
    for j, l in enumerate(ls):
        ...
        def psi_r(i, x):
            ...
            new_walkers = new_walkers.at[jnp.index_exp[:,i,:]].set(coords)
        ...
        def integral(i, res):
            ...
            res = res.at[jnp.index_exp[i,j]].set(result)
            return res
