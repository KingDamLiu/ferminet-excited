...
def make_fermi_net_layers(
  ...
  def apply(
    ...
    print('features:', ae_features.shape, ee_features.shape)
    ...
    print('h shape:', h_one.shape, h_two[0].shape, h_elec_ion.shape)
    for i in range(len(options.hidden_dims)):
...
def make_orbitals(
  ...
  def apply(
    ...
    print('position vector:', ae.shape, ee.shape, r_ae.shape, r_ee.shape)
