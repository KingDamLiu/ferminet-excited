...
spins = [1,0,1,0,1,2,3,2,1,0,1,0,1,2,3,2,1,0,1,0,1,2,3,6,3,4,3,2,1]
# 以类Be原子为例
for ecp_flag in [False]:
    for num_atom in range(6,7):
        if not ecp_flag:
            cfg.system.ecp = True
            # 全电子
            Num_e = num_atom+1
        ...
        cfg.log.save_path = "experiment_data/ferminet/"+periodic_table[num_atom]+"_2_2_ecp_ferminet1/"
